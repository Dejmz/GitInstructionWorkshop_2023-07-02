...
Система контроля версий нужна, чтобы любое изменение можно было отследить и в случае необходимости откатить изменение. Так же, система контроля версий позволяет нескольким разработчикам работать над одним проектом одновременно.
